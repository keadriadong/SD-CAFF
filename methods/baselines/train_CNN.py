...
def train(dataset, feature_type, model_name, data_num, root_dir):
    ...
    if dataset == 'IEMOCAP':
        ...
        file = root_dir + r'MSP/MSP_data/MSP_leave_{}_data_16000.pkl'.format(str(data_num))
    elif dataset == 'MELD':
    ...
    for i in range(Epoch):
        ...
        for _, data in enumerate(train_loader):
            ...
            attn, out_emotion, out_gender, out_emotion_center, out_gender_center = model(x.unsqueeze(1))
            # run delta!!!!!
            ...
            loss = alpha * (loss_emotion + center_rate * center_loss_emotion) \
                   + beta * (loss_gender + center_rate * center_loss_gender)
        ...
        for i in range(len(val_y)):
            ...
            out_a, out_emotion, out_gender, out_emotion_center, out_gender_center = model(x.unsqueeze(0).unsqueeze(0))
            #
