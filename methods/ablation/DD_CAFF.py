...
class DD_CAFF(nn.Module):
    def __init__(self, DyRELU=True, Center=True, Gender=True, if_bidirectional=False, inter_channels=32):
        ...
        self.lstm0 = nn.LSTM(
            input_size=60, hidden_size=self.mid_features, num_layers=self.num_layers,
    ...
    def forward(self, *input):
        ...
        x_static = x_lstm0.permute(0,2,1).unsqueeze(2)
