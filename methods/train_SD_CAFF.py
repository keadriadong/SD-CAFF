...
if __name__ == '__main__':
    ...
    datasets = ['IEMOCAP', 'MSP']
    feature_types = ['mfcc_delta']
    num = 5
    ...
    for dataset in datasets:
        for feature_type in feature_types:
            root_dir = "/home/results_Fusion/"
            avg_WA, avg_UA = 0, 0
            para = [[0.5, 0.5], [0.7, 0.3], [0.7, 0.3], [1, 1, 1]]
            for n in range(num):
                maxWA, maxUA, best_matrix = train(dataset, feature_type, n, root_dir, para)
                avg_WA += maxWA
                avg_UA += maxUA
            avg_WA /= num
            avg_UA /= num
