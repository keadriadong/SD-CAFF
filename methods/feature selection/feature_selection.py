...
class SD_CAFF(nn.Module):
    def __init__(self, feature_num=1, DyRELU=True, Center=True, Gender=True, if_bidirectional=False, inter_channels=32):
        super(SD_CAFF, self).__init__()
        print(feature_num)
        # ------------------CNN-DEFINE------------------#
        self.DyRELU = DyRELU
        self.Center = Center
        ...
        self.lstm = nn.LSTM(
            input_size=60*feature_num, hidden_size=self.mid_features, num_layers=self.num_layers,
    ...
    def forward(self, *input):
        ...
        # print(x_s_local.shape, x_s_global.shape, x_d_local.shape, x_d_global.shape)
